...
class QuizCreateViewController: UIViewController, KeyboardHandler {
    ...
    private func doneStartDatePicker() {
        ...
        startDateButton.setTitle("Starts: \(str)", for: .normal)
    ...
    private func doneEndDatePicker() {
        ...
        endDateButton.setTitle("Ends: \(str)", for: .normal)
